...
PICS = (environ.get('PICS', 'https://telegra.ph/file/d5fff333c5e6ea130c5c2.jpg')).split() #SAMPLE PIC
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002200563135')).split()]
...
CLONE_DATABASE_URI = environ.get('CLONE_DATABASE_URI', "mongodb+srv://mom:mom@uppa.chcolij.mongodb.net/?retryWrites=true&w=majority&appName=uppa") # Necessary If clone mode is true
PUBLIC_FILE_CHANNEL = environ.get('PUBLIC_FILE_CHANNEL', 'publicbyleo1') # Public Channel Username Without @ or without https://t.me/ and Bot Is Admin With Full Right.
